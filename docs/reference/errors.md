...
AxisNow SDK 所有 API 返回 `0` 表示成功，**负数表示失败**。错误码按子系统分段：
...
如需结合**排障流程**定位问题，参见 [排障](../resources/troubleshooting.md)。
...
| `-301` ～ `-331` | 代理 listener 故障 | 见 [排障 §2.2](../resources/troubleshooting.md#22-代理连接问题) |
